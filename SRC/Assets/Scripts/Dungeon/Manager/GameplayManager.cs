...
namespace Dungeon
{
	public class GameplayManager 
	{
		...
		public void InitNewFloor(Tilemap tilemap, TileBase[] tiles, FloorData floorData)
		{
			FloorConstructor.Construct(m_characterManager, m_floorManager, null, null, floorData, tilemap, tiles);
